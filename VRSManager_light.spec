...
"""
PyInstaller spec file for VRS Manager LIGHT Version

LIGHT version excludes:
- PyTorch (torch)
- sentence-transformers
- BERT model
- All ML dependencies

Result: ~150MB .exe with core features only
StrOrigin Analysis shows: "Punctuation/Space Change" or "Content Change"
"""
...
a = Analysis(
    ...
    datas=[
        ...
        # NOTE: BERT model NOT included in LIGHT version
    ],
    hiddenimports=[
        ...
        'src.utils.strorigin_analysis',  # Included - handles LIGHT mode gracefully
        'src.utils.super_groups',
        # NOTE: NO torch, transformers, sentence_transformers in LIGHT version
    ],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[
        ...
        'setuptools',
        'distutils',
        # Explicitly exclude BERT/ML packages
        'torch',
        'transformers',
