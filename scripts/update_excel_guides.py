...
VERSION = "12051800"
VERSION_TEXT_EN = "Version 12051800 (Smarter Change Detection + Enhanced Tracking)"
VERSION_TEXT_KR = "버전 12051800 (스마트 변경 감지 + 향상된 추적)"

# English content to add
EN_HEADER = "WHAT'S NEW IN v12051800?"
EN_CONTENT = [
    {
