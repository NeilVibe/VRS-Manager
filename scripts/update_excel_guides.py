...
VERSION = "12051333"
VERSION_TEXT_EN = "Version 12051333 (Smarter Change Detection + Enhanced Tracking)"
VERSION_TEXT_KR = "버전 12051333 (스마트 변경 감지 + 향상된 추적)"

# English content to add
EN_HEADER = "WHAT'S NEW IN v12051333?"
EN_CONTENT = [
    {
